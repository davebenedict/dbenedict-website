...
const projects = [
  {
    id: 1,
    name: 'dbenedict-website',
    description: 'Personal and business website with subdomain routing built with Next.js',
    url: 'https://github.com/davebenedict/dbenedict-website',
    language: 'TypeScript',
    stars: 0,
          ...
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <Link href="/personal/portfolio" className="text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium">
                  Portfolio
                </Link>
